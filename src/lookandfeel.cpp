                                    ...
                                    juce::Slider& slider)
{
    ...
    juce::ColourGradient grad (
        juce::Colours::black.withAlpha (0.15f), centre.x, centre.y, juce::Colours::transparentBlack, centre.x + radius, centre.y + radius,
                                ...
                                juce::ComboBox& box)
{
    ...
    juce::Path triangle;
    triangle.addTriangle (x - triangleSize, y - triangleSize * 0.5f, x + triangleSize, y - triangleSize * 0.5f, x, y + triangleSize * 0.5f);
    g.fillPath (triangle);
}
...
void LookAndFeel::drawPopupMenuBackground (juce::Graphics& g, int width, int height)
{
    ...
    juce::ColourGradient grad (
        juce::Colours::white.withAlpha (0.02f), 0, 0, juce::Colours::white.withAlpha (0.0f), 0, (float) height, false);
    g.setGradientFill (grad);
    g.fillRect (1, 1, width - 2, height - 2);
}
